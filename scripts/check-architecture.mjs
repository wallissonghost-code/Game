...
if (!skillsBootstrap.includes('await loadPatchedClassic(gameRuntimeUrl)')) fail('skills bootstrap does not start patched classic gameplay runtime');
else ok('skills bootstrap starts patched classic gameplay runtime');
