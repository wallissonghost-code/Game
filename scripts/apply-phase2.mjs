...
function replaceIfNeeded(source, from, to, label) {
...
console.log('Phase 2 migration verified/applied: skills extracted + modular bootstrap enabled.');
