...
function patchGuardianCelestial(source){
  ...
  one(
    "const skillLv={speed:0,medic:0,rapid:0,xp:0,flash:0,regen:0,blood:0,arc:0,phoenix:0,armor:0,pierce:0,ghost:0,dodge:0,ice:0,shock:0,berserker:0,explosive:0};",
    "const skillLv={speed:0,medic:0,rapid:0,xp:0,flash:0,regen:0,blood:0,arc:0,phoenix:0,armor:0,pierce:0,ghost:0,dodge:0,ice:0,shock:0,berserker:0,explosive:0,guardian:0};",
    'solo-state'
  );
